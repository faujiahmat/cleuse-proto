...
type ProductServiceClient interface {
	FindManyByIdsForCart(ctx context.Context, in *ProductIds, opts ...grpc.CallOption) (*ProductCartResponse, error)
	ReduceStocks(ctx context.Context, in *ReduceStocksRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	RollbackStocks(ctx context.Context, in *RollbackStocksRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *productServiceClient) FindManyByIdsForCart(ctx context.Context, in *ProductIds, opts ...grpc.CallOption) (*ProductCartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductCartResponse)
...
func (c *productServiceClient) ReduceStocks(ctx context.Context, in *ReduceStocksRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productServiceClient) RollbackStocks(ctx context.Context, in *RollbackStocksRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type ProductServiceServer interface {
	FindManyByIdsForCart(context.Context, *ProductIds) (*ProductCartResponse, error)
	ReduceStocks(context.Context, *ReduceStocksRequest) (*emptypb.Empty, error)
	RollbackStocks(context.Context, *RollbackStocksRequest) (*emptypb.Empty, error)
...
func (UnimplementedProductServiceServer) FindManyByIdsForCart(context.Context, *ProductIds) (*ProductCartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindManyByIdsForCart not implemented")
}
func (UnimplementedProductServiceServer) ReduceStocks(context.Context, *ReduceStocksRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReduceStocks not implemented")
}
func (UnimplementedProductServiceServer) RollbackStocks(context.Context, *RollbackStocksRequest) (*emptypb.Empty, error) {
...
func _ProductService_ReduceStocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ReduceStocks(ctx, req.(*ReduceStocksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductService_RollbackStocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).RollbackStocks(ctx, req.(*RollbackStocksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
