...
type UserServiceClient interface {
	...
	AddRefreshToken(ctx context.Context, in *AddRefreshTokenRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userServiceClient) AddRefreshToken(ctx context.Context, in *AddRefreshTokenRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type UserServiceServer interface {
	...
	AddRefreshToken(context.Context, *AddRefreshTokenRequest) (*emptypb.Empty, error)
...
func (UnimplementedUserServiceServer) AddRefreshToken(context.Context, *AddRefreshTokenRequest) (*emptypb.Empty, error) {
